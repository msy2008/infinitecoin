...
in `gitian.sigs.ifc` to your signing machine and do
...
[gitian.sigs.ifc](https://github.com/infinitecoin-project/gitian.sigs.ifc/) repository, or if that's not possible create a pull
